...
class linearGradient(svg_tag):
  '''
  The <linearGradient> element lets users define linear gradients that can be applied to fill or
...
class radialGradient(svg_tag):
  '''
  The <radialGradient> element lets users define radial gradients that can be applied to fill
