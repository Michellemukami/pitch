...
def login_url(login_view, next_url=None, next_field='next'):
    ...
    unuserized handler uses this function when redirecting to your login url.
...
def login_required(func):
    ...
    not, it calls the :attr:`LoginManager.unuserized` callback.) For
    example::
    ...
    logged in, you can do so with::
        ...
        if not current_user.is_authenticated:
            return current_app.login_manager.unuserized()
...
def fresh_login_required(func):
    ...
    If the user is not authenticated, :meth:`LoginManager.unuserized` is
