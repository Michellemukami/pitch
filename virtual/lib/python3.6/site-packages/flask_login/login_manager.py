...
from .signals import (user_loaded_from_cookie, user_loaded_from_header,
                      user_loaded_from_request, user_unuserized,
...
class LoginManager(object):
    ...
    def unuserized(self):
        ...
        callback with :meth:`LoginManager.unuserized_handler`, then it will
        ...
        raise a HTTP 401 (Unuserized) error instead.

        This should be returned from a view or before/after_request function,
        otherwise the redirect will have no effect.
        '''
        user_unuserized.send(current_app._get_current_object())

        if self.unuserized_callback:
            return self.unuserized_callback()
    ...
    def unuserized_handler(self, callback):
        '''
        This will set the callback for the `unuserized` method, which among
        other things is used by `login_required`. It takes no arguments, and
        should return a response to be sent to the user instead of their
        normal view.

        :param callback: The callback for unuserized users.
        :type callback: callable
        '''
        self.unuserized_callback = callback
        return callback
    ...
    def needs_refresh(self):
        ...
        simply raise a HTTP 401 (Unuserized) error instead.
