...
class Unuserized(HTTPException):
    """*401* ``Unuserized``

    Raise if the user is not userized to access a resource.
    ...
    code = 401
    description = (
        "The server could not verify that you are userized to access"
...
class Gone(HTTPException):
    ...
    description = (
        ...
        " foreign page, please contact the user of this page."
    )
