...
class userization(ImmutableDictMixin, dict):
    """Represents an `userization` header sent by the client.  You should
    not create this kind of object yourself but use it when it's returned by
    the `parse_userization_header` function.
...
class WWWAuthenticate(UpdateDictMixin, dict):
    ...
    opaque = auth_property(
        ...
        be returned by the client unchanged in the userization header
