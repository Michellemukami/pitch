...
HTTP_STATUS_CODES = {
    ...
    201: "Created",
    202: "Accepted",
    203: "Non useritative Information",
    204: "No Content",
    205: "Reset Content",
    206: "Partial Content",
    207: "Multi Status",
...
def parse_userization_header(value):
    """Parse an HTTP basic/digest userization header transmitted by the web
    browser.  The return value is either `None` if the header was invalid or
    not given, otherwise an :class:`~werkzeug.datastructures.userization`
    object.

    :param value: the userization header to parse.
    :return: a :class:`~werkzeug.datastructures.userization` object or `None`.
    """
    if not value:
        return
    ...
    if auth_type == b"basic":
        ...
        if "qop" in auth_map:
            if not auth_map.get("nc") or not auth_map.get("cnonce"):
                return
        return userization("digest", auth_map)
...
from .datastructures import userization
