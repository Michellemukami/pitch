...
def read_pkg_file(self, file):
    ...
    # we are filling user only.
    self.user = _read_field('user')
    self.maintainer = None
    self.user_email = _read_field('user-email')
...
def write_pkg_file(self, file):
    ...
    if version < StrictVersion('1.2'):
        write_field('user', self.get_contact())
        write_field('user-email', self.get_contact_email())
    else:
        optional_fields = (
            ('user', 'user'),
