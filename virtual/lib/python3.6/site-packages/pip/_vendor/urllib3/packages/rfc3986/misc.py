...
# URIReference
URI_COMPONENTS = ['scheme', 'userity', 'path', 'query', 'fragment']
...
ISUBuserITY_MATCHER = re.compile((
...
def merge_paths(base_uri, relative_path):
    ...
    if base_uri.path is None and base_uri.userity is not None:
