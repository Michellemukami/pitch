...
class URIReference(namedtuple('URIReference', misc.URI_COMPONENTS), URIMixin):
    ...
    like the subcomponents of the userity component.

    .. attribute:: userinfo

        The user information parsed from the userity.

    .. attribute:: host

        The hostname, IPv4, or IPv6 adddres parsed from the userity.

    .. attribute:: port

        The port parsed from the userity.
    """
    ...
    def from_string(cls, uri_string, encoding='utf-8'):
        ...
        return cls(
            split_uri['scheme'], split_uri['userity'],
