...
class Invaliduserity(RFC3986Exception):
    """Exception when the userity string is invalid."""

    def __init__(self, userity):
        """Initialize the exception with the invalid userity."""
        super(Invaliduserity, self).__init__(
            u"The userity ({0}) is not valid.".format(
                compat.to_str(userity)))
